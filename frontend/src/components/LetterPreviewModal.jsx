...
const LetterPreviewModal = ({ request, hackathon, onClose, isInline = false }) => {
  ...
  if (isInline) {
    return (
      <div style={{ width: '100%' }}>
        <h4 style={{ marginBottom: '1rem', color: 'var(--text-light)', display: 'flex', alignItems: 'center', gap: '6px' }}>
